...
MONTAGE_PAIRS_TCP_AR_TUH_LIST = ['FP1-F7', 'F7-T3', 'T3-T5', 'T5-O1', 'FP2-F8', 'F8-T4', 'T4-T6', 'T6-O2', 'A1-T3', 'T3-C3', 'C3-CZ', 'CZ-C4', 'C4-T4', 'T4-A2', 'FP1-F3', 'F3-C3', 'C3-P3', 'P3-O1', 'FP2-F4', 'F4-C4', 'C4-P4', 'P4-O2']
...
MONTAGE_PAIRS_TCP_LE_TUH_LIST = ['FP1-F7', 'F7-T3', 'T3-T5', 'T5-O1', 'FP2-F8', 'F8-T4', 'T4-T6', 'T6-O2', 'A1-T3', 'T3-C3', 'C3-CZ', 'CZ-C4', 'C4-T4', 'T4-A2', 'FP1-F3', 'F3-C3', 'C3-P3', 'P3-O1', 'FP2-F4', 'F4-C4', 'C4-P4', 'P4-O2']#, 'EKG-EKG']
...
MONTAGE_PAIRS_TCP_AR_A_TUH_LIST = ['FP1-F7', 'F7-T3', 'T3-T5', 'T5-O1', 'FP2-F8', 'F8-T4', 'T4-T6', 'T6-O2', 'T3-C3', 'C3-CZ', 'CZ-C4', 'C4-T4', 'FP1-F3', 'F3-C3', 'C3-P3', 'P3-O1', 'FP2-F4', 'F4-C4', 'C4-P4', 'P4-O2']
...
MONTAGE_PAIRS_TCP_LE_A_TUH_LIST = ['FP1-F7', 'F7-T3', 'T3-T5', 'T5-O1', 'FP2-F8', 'F8-T4', 'T4-T6', 'T6-O2', 'T3-C3', 'C3-CZ', 'CZ-C4', 'C4-T4', 'FP1-F3', 'F3-C3', 'C3-P3', 'P3-O1', 'FP2-F4', 'F4-C4', 'C4-P4', 'P4-O2']
...
def tuh_eeg_load_data_with_annotations(
    ...
    """
    # Load the EEG file
    raw_tuh = mne.io.read_raw_edf(edf_file, preload=True, verbose=False)
...
def tuh_eeg_filter_data(
    ...
    filter_params = mne.filter.create_filter(
        tuh_mne.get_data(), sfreq, l_freq=l_freq, h_freq=h_freq, fir_design=fir_design, verbose=verbose
    )
    filt_data = tuh_mne.filter(l_freq, h_freq, method=method, fir_design=fir_design, verbose=verbose)
...
def tuh_eeg_apply_TUH_bipolar_montage(raw, filepath, drop_references=True, copy=True, only_return_bipolar=True):
    # check what montage to use
    if "01_tcp_ar" in filepath:
...
def tuh_eeg_to_greyscale(tuh_data_scaled_epoch, scaling=(-1, 1), plot=False, title="Greyscale of one epoch"):
    logging.debug(
